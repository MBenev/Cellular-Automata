...
public class MapGenerator : MonoBehaviour
{
    ...
    void GenerateMap()
    {
        ...
        for (int x = 0; x < borderedMap.GetLength(0); x++)
        {
            ...
            { 
                // x value is inside of the map  (mine)
    ...
    void ConnectClosestRooms(List<Room> allRooms)
    {
        ...
        foreach(Room roomA in allRooms)
        {
            ...
            foreach(Room roomB in allRooms)
            {
                ...
                {
                    possibleConnectionFound = false; // If we've already found a possible connection, it's going to go to the if(possibleConnectionFound), and we don't want that created.
                    break;
                }
